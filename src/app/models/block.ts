...
export class Block {
    ...
    constructor(params: Params) {
        ...
        trashTexture.diffuseTexture = new BABYLON.Texture("/assets/textures/trash2.jpg", params.scene);


       // var mainTexture = new BABYLON.Texture("/assets/textures/trash.jpg", params.scene); // set shader texture resource
       // this.shape.material = mainTexture
