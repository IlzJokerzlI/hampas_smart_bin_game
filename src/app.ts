...
class App {
    ...
    constructor(ammo: typeof Ammo) {
        ...
        scene.enablePhysics(new BABYLON.Vector3(0, 0, 0), new BABYLON.AmmoJSPlugin(true, this.ammo))
        ...
        block.ellipsoid = new BABYLON.Vector3(0.5, 0.5, 0.5)
        block.physicsImpostor = new BABYLON.PhysicsImpostor(block, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, friction: 0, restitution: 0 })

        // Block
        let block2 = BABYLON.MeshBuilder.CreateBox('block', { height: 1, width: 1, depth: 1, }, scene)
        block2.enableEdgesRendering()
        block2.edgesColor = new BABYLON.Color4(1, 1, 1, 1)
        block2.position = new BABYLON.Vector3(0, 3, 0)
        block2.ellipsoid = new BABYLON.Vector3(0.5, 0.5, 0.5)
        block2.checkCollisions = true
        block2.physicsImpostor = new BABYLON.PhysicsImpostor(block2, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, friction: 0, restitution: 0 }, scene)
